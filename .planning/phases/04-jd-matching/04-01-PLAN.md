...
must_haves:
  ...
  artifacts:
    ...
    - path: "src/renderer/components/jd/JDInput.tsx"
      provides: "JD paste/submit UI component"
      contains: "JDInput"
      min_lines: 50
...
Purpose: Enable users to paste job descriptions and have them parsed into structured requirements (required skills, preferred skills, experience level, education). This forms the foundation for CV-JD matching in subsequent plans.
...
- JD input UI component with paste functionality
...
<task type="auto">
  <name>Task 3: Create JD input UI and store</name>
  <files>
    src/renderer/stores/jdStore.ts
    src/renderer/components/jd/JDInput.tsx
...
- JDInput component created with textarea and extract button
...
- [ ] JDInput.tsx component with paste/extract functionality
