...
must_haves:
  truths:
    ...
    - "Prompts guide LLM to extract work history, education, and skills accurately"
  ...
  artifacts:
    ...
    - path: "python-src/extractors/llm/schemas.py"
      provides: "Pydantic models for LLM output (LLMWorkHistory, LLMEducation, LLMSkills)"
      contains: "class LLMWorkHistory"
      min_lines: 60
    - path: "python-src/extractors/llm/prompts.py"
      provides: "Extraction prompts (WORK_HISTORY_PROMPT, EDUCATION_PROMPT, SKILLS_PROMPT)"
      contains: "WORK_HISTORY_PROMPT"
      min_lines: 40
...
from extractors.llm.prompts import WORK_HISTORY_PROMPT, EDUCATION_PROMPT, SKILLS_PROMPT
